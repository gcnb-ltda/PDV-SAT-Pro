...
- Produção nacional direta: removida a dependência da Focus NFe; certificado, senha e CSC são locais e o destino previsto são os Web Services estaduais/virtuais oficiais (`RF55`). A produção permanece bloqueada até homologar XML 4.00, XMLDSig, mTLS/SOAP, QR Code, schemas, contingência e respostas por UF. A validade efetiva depende do credenciamento e homologação de cada estabelecimento.
